    ...
    <p>&nbsp;</p>
            ...
            <section id="cont_der">
            	<div id="work">
                	...
                	<div id="workspace">
                    	<br />
                        <form name="nivel_uno" id="nivel_uno"  action="../../cont/Con_registrar_ronda.php" method="post">
<table width="364" id="tabla_nivel1"><tr><td>1- Pregunta</td></tr></table>
</br>
...
<tr>
  <?php 
	$pre=new Pregunta();
    $resultado=$pre->mostrarPregunta(1);
