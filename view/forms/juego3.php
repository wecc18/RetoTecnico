    ...
    <p>&nbsp;</p>
            ...
            <section id="cont_der">
            	<div id="work">
                	...
                	<div id="workspace">
                    	<br />
                        <form name="nivel_tres" id="nivel_tres"  action="../../cont/Con_registrar_ronda3.php" method="post">
<table width="364" id="tabla_nivel3"><tr><td>3- Pregunta</td></tr></table>
</br>
...
<tr>
  <?php 
	$pre=new Pregunta();
    $resultado=$pre->mostrarPregunta3(3);
