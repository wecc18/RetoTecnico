    ...
    <p>&nbsp;</p>
            ...
            <section id="cont_der">
            	<div id="work">
                	...
                	<div id="workspace">
                    	<br />
                        <form name="nivel_cuatro" id="nivel_cuatro"  action="../../cont/Con_registrar_ronda4.php" method="post">
<table width="364" id="tabla_nivel4"><tr><td>4- Pregunta</td></tr></table>
</br>
<table id="tabla_formulario">
<tr><td>&nbsp;</td><td colspan="3" id="respuesta"><input type="hidden" name="valida" id="valida" value="1"/></td></tr>
<tr>
  <?php 
	$pre=new Pregunta();
    $resultado=$pre->mostrarPregunta4(4);
