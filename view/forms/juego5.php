    ...
    <p>&nbsp;</p>
            ...
            <section id="cont_der">
            	<div id="work">
                	...
                	<div id="workspace">
                    	<br />
                        <form name="nivel_cinco" id="nivel_cinco"  action="../../cont/Con_registrar_ronda5.php" method="post">
<table width="364" id="tabla_nivel5"><tr><td>5- Pregunta</td></tr></table>
</br>
...
<tr>
  <?php 
	$pre=new Pregunta();
    $resultado=$pre->mostrarPregunta5(5);
